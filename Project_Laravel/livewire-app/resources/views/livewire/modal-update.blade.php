...
<div class="flex flex-col overflow-clip">
    ...
    <div class="flex flex-row justify-between p-5 border-gray-200 border-t items-center">
        @if ($this->techlogIdSelector)
            <button x-data x-on:click="alert('Are you sure you want to delete this?')" wire:click="deleteUser()" type="submit" class="hover:text-white text-[#302714] px-4 py-2 rounded-2xl border border-red-300 hover:bg-red-600" style="max-width: 30%">
                Cancel order
            </button>
